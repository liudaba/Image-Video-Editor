...
NEW_VERSION = "1.0.12"
FROM_VERSIONS = ["1.0.0", "1.0.1", "1.0.2", "1.0.3", "1.0.4", "1.0.5", "1.0.6", "1.0.7", "1.0.8", "1.0.9", "1.0.10", "1.0.11"]

CHANGELOG = [
    "修复日志时间与本地时间差8小时的问题",
    "使用time.localtime()替代datetime.now()确保时区正确",
    "修复文件日志和GUI日志时间戳统一为本地时间",
]
...
print("\n[5/5] 验证：模拟客户端检查更新")
for from_ver in ["1.0.11", "1.0.10", "1.0.5", "1.0.0"]:
